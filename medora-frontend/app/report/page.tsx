...
// Type for raw boxes as stored after conversion
type RawBoxType =
  | {
      x1?: number;
      y1?: number;
...
function formatDate(value?: Timestamp | string | null) {
  ...
  if (typeof value === "string") {
    // Handle "2026-05-12 05:53:16" format
  ...
  useEffect(() => {
    const fetchCase = async () => {
      try {
        ...
        // 7. Model name (could be stored or default)
        const modelName = data.modelName || "EfficientNet-B3 + YOLOv8";
